...
export const SELECTED_BOOKS_KEYS: TSelectedKeys = {
  [BOOK_ITEM]: [
    ...SELECTED_BOOK.filter(({ key }) => key !== "articleEditor"),
    ...ADDITIONAL_BOOK_OPTIONS,
    ...EDITOR_OPTION
  ],
  [SERIES_RESOURSE_ITEM]: [
    ...SELECTED_SERIES_RESOURCE.filter(({ key }) => key !== "articleEditor"),
    ...EDITOR_OPTION
  ],
  [SCIENCE_WORKS_ITEM]: SELECTED_SCIENCE_WORKS,
  [MULTI_VOLUME_BOOKS_ITEM]: [
    ...SELECTED_MULTI_VOLUME_BOOK.filter(({ key }) => key !== "volumeName" && key !== "articleEditor"),
    ...ADDITIONAL_MULTI_VOLUME_OPTIONS,
    ...EDITOR_OPTION
  ],
...
export const SELECTED_PAPER_KEYS: TSelectedKeys = {
  ...
  [PAPER_FROM_BOOK_ITEM]: [
    ...SELECTED_PAPER_FROM_BOOK.filter(({ key }) => key !== "articleEditor"),
    ...EDITOR_OPTION
  ],
